...
const VERSION = '2026-09-08-5';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v42'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v37';    // <-- bumpa vid nästa release
