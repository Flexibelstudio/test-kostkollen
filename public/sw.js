...
const VERSION = '2026-09-08-1';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v38'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v33';    // <-- bumpa vid nästa release
