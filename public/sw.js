...
const VERSION = '2025-12-17-4';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v28'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v23';    // <-- bumpa vid nästa release
