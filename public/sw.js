...
const VERSION = '2025-11-29-2';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v24'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v19';    // <-- bumpa vid nästa release
