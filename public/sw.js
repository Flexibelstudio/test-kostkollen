...
const VERSION = '2026-09-11-2';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v51'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v46';    // <-- bumpa vid nästa release
