...
const VERSION = '2026-09-11-3';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v52'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v47';    // <-- bumpa vid nästa release
