...
const VERSION = '2026-09-08-7';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v44'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v39';    // <-- bumpa vid nästa release
