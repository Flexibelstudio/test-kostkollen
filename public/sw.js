...
const VERSION = '2026-09-08-4';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v41'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v36';    // <-- bumpa vid nästa release
