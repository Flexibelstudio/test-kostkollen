...
const VERSION = '2026-09-04-5';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v35'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v30';    // <-- bumpa vid nästa release
