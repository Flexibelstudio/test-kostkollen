...
const VERSION = '2026-08-06-1';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v27'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v22';    // <-- bumpa vid nästa release
