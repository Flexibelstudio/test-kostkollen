...
const VERSION = '2026-09-08-2';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v39'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v34';    // <-- bumpa vid nästa release
