...
const VERSION = '2026-09-08-12';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v49'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v44';    // <-- bumpa vid nästa release
