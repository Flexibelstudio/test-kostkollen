...
const VERSION = '2025-10-01-1';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v19'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v14';    // <-- bumpa vid nästa release
