...
const VERSION = '2026-09-08-10';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v47'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v42';    // <-- bumpa vid nästa release
