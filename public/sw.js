...
const VERSION = '2026-09-11-1';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v50'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v45';    // <-- bumpa vid nästa release
