...
const VERSION = '2026-09-08-3';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v40'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v35';    // <-- bumpa vid nästa release
