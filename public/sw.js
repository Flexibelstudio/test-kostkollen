...
const VERSION = '2025-10-12-2';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v21'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v16';    // <-- bumpa vid nästa release
