...
const VERSION = '2026-09-08-6';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v43'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v38';    // <-- bumpa vid nästa release
