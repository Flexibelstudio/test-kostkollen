...
const VERSION = '2026-09-04-2';                // <-- bumpa vid nästa release
const STATIC_CACHE_NAME  = 'kostloggen-static-v32'; // <-- bumpa vid nästa release
const DYNAMIC_CACHE_NAME = 'kostloggen-dyn-v27';    // <-- bumpa vid nästa release
