        ...
        <section className="bg-white p-5 sm:p-6 rounded-xl shadow-soft-lg border border-neutral-light">
            ...
            {isExpanded && (
                <div id="group-insights-panel" className="mt-4 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 animate-fade-in">
                    ...
                    <StatCard icon={<FireIcon className="w-6 h-6 text-orange-800" />} title="Mål: Fettminskning" value={groupInsights.loseFatCount.toString()} subtitle={`${groupInsights.gainMuscleCount} Muskel↑, ${groupInsights.maintainCount} Bibehåll`} colorClass="bg-orange-100" />
                    ...
                    <StatCard icon={<ScaleIcon className="w-6 h-6 text-primary-darker" />} title="Snitt-viktnedgång (7d)" value={`${groupInsights.averageWeeklyLoss.toFixed(1)} kg`} subtitle="Av medlemmar med minskning" colorClass="bg-primary-100" />
