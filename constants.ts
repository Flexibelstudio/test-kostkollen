...
export const VAPID_PUBLIC_KEY = 'BGbB7XzSqtRwYPbexvRXqQtZPrG_Hv8UqrSDh2X9FqXLK2sejKcSaQbvLw1uYcPbqCftv3I439yy_Ey__FbfseM';
...
export const MANUAL_LOG_FOOD_ICON_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path d="M7.75 2.75a.75.75 0 0 0-1.5 0V4.5h-.5A.75.75 0 0 0 4 5.25v9.5A.75.75 0 0 0 4.75 15.5h.5V17.25a.75.75 0 0 0 1.5 0V15.5h.5A.75.75 0 0 0 8 14.75V5.25A.75.75 0 0 0 7.25 4.5h-.5V2.75Z" /><path d="M12.25 2.75a.75.75 0 0 0-1.5 0V17.25a.75.75 0 0 0 1.5 0V2.75Z" /><path d="M15.5 5.5A1.5 1.5 0 0 0 14 4H9.75a.75.75 0 0 0 0 1.5H14a1.5 1.5 0 0 1 1.5 1.5v2.25a.75.75 0 0 0 1.5 0v-2.25A2.5 2.5 0 0 0 14.5 4H14c0-1.052.284-2.02.787-2.822a.75.75 0 0 0-.895-1.085A4.002 4.002 0 0 0 9.75 2H9.5a.75.75 0 0 0 0 1.5h.25a2.5 2.5 0 0 1 2.5 2.5V14.5a2.5 2.5 0 0 1-2.5 2.5h-.25a.75.75 0 0 0 0 1.5h.25a4.002 4.002 0 0 0 4.032-3.678A.75.75 0 0 0 15.5 14.5V5.5Z" /></svg>`;
export const COMMON_MEAL_LOG_ICON_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"><path fill-rule="evenodd" d="M4.5 2A1.5 1.5 0 0 0 3 3.5v13A1.5 1.5 0 0 0 4.5 18h11a1.5 1.5 0 0 0 1.5-1.5V7.621a1.5 1.5 0 0 0-.44-1.06l-4.12-4.122A1.5 1.5 0 0 0 11.378 2H4.5Zm2.25 8.5a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5h-6.5Zm0 3a.75.75 0 0 0 0 1.5h6.5a.75.75 0 0 0 0-1.5h-6.5Z" clip-rule="evenodd" /><path d="M12.878 2.553a.75.75 0 0 0-.53-.223H12v3.75h3.75V6.12A.75.75 0 0 0 15.45 5.59l-2.572-2.572Z" /></svg>`;
export const SEARCH_ICON_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="%23000000"><path stroke-linecap="round" stroke-linejoin="round" d="m21 21-5.197-5.197m0 0A7.5 7.5 0 1 0 5.196 5.196a7.5 7.5 0 0 0 10.607 10.607Z" /></svg>`;
export const RECIPE_ICON_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="%23000000"><path stroke-linecap="round" stroke-linejoin="round" d="M12 6.042A8.967 8.967 0 0 0 6 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 0 1 6 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 0 1 6-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0 0 18 18a8.967 8.967 0 0 0-6 2.292m0-14.25v14.25" /></svg>`;
export const BARCODE_ICON_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="%23000000"><path stroke-linecap="round" stroke-linejoin="round" d="M3.75 4.5v15a2.25 2.25 0 0 0 2.25 2.25h13.5a2.25 2.25 0 0 0 2.25-2.25v-15a2.25 2.25 0 0 0-2.25-2.25H5.25a2.25 2.25 0 0 0-2.25 2.25Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M8.25 9v6m3-6v6m3-6v6" /></svg>`;
export const BOOKMARK_ICON_SVG = `data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="%23000000"><path stroke-linecap="round" stroke-linejoin="round" d="M17.593 3.322c1.1.128 1.907 1.077 1.907 2.185V21L12 17.5 4.5 21V5.507c0-1.108.806-2.057 1.907-2.185a48.507 48.507 0 0 1 11.186 0Z" /></svg>`;
