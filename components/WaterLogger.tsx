...
const WaterLogger = React.forwardRef<HTMLDivElement, WaterLoggerProps>(({
  ...
  return (
    <div ref={ref} className={`relative overflow-hidden ${'bg-white dark:bg-[#2B2825] border-neutral-light dark:border-[#484440]'} rounded-[22px] shadow-soft-xl border h-full flex flex-col justify-between group select-none ${disabled ? 'opacity-70' : ''}`}>
