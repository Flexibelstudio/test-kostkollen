      ...
      >
        ...
        <div className="space-y-6">
            ...
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 p-6 rounded-2xl border border-orange-200 text-center">
                ...
                <p className="text-sm font-bold text-orange-800 uppercase tracking-wider mb-1">Nuvarande Streak</p>
                ...
                {nextLevel && (
                    <div className="mt-4 bg-white/60 p-2 rounded-lg text-sm text-orange-900">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="bg-white border-2 border-yellow-100 rounded-2xl p-4 text-center shadow-sm">
            ...
            <div className="bg-neutral-light/30 p-4 rounded-xl border border-neutral-light">
                <p className="text-sm text-neutral-dark leading-snug">
                    <strong className="text-primary-darker">Tips:</strong> Din streak bygger på konsekvens. Logga minst en måltid varje dag för att hålla den vid liv!
                </p>
            </div>
        </div>
