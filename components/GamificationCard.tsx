...
import { TrophyIcon, LifebuoyIcon } from './icons';
      ...
      <div className="mb-5 space-y-4">
        <div>
         ...
         <div>
            ...
            <p className="text-sm text-neutral">
                Varje måndag får du en ny 'Streakräddare'. Om du misslyckas med en dag kan du dagen efter använda den för att reparera din streak! 
                <br/>
