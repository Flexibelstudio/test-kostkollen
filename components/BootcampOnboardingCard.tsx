          ...
          return (
            <div 
              ...
              className={`p-3 sm:p-3.5 rounded-2xl border transition-all flex flex-col sm:flex-row sm:items-center justify-between gap-3 ${
                isDone 
                  ? 'bg-white/5 border-[#7BA05B]/40 text-white/80' 
            ...
            >
              <div className="flex items-start gap-3">
                <div className={`w-8 h-8 rounded-xl flex items-center justify-center shrink-0 mt-0.5 ${
                  isDone 
                    ? 'bg-[#7BA05B]/20 text-[#7BA05B] border border-[#7BA05B]/30' 
              ...
              <div className="flex items-center gap-2 self-end sm:self-center shrink-0">
                {isDone ? (
                  <span className="text-xs font-bold text-[#7BA05B] bg-[#7BA05B]/20 px-3 py-1.5 rounded-xl inline-flex items-center gap-1 border border-[#7BA05B]/30 font-mono">
                    Klar ✓
                  </span>
                ) : (
                  <button
