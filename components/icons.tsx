...
export const SmileIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
...
export const MehIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15 15H9M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Z" />
  </svg>
);

export const FrownIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.182 16.318A4.486 4.486 0 0 0 12.01 15a4.486 4.486 0 0 0-3.198 1.318M21 12a9 9 0 1 1-18 0 9 9 0 0 1 18 0ZM9.75 9.75c0 .414-.168.75-.375.75S9 10.164 9 9.75 9.168 9 9.375 9s.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Zm5.625 0c0 .414-.168.75-.375.75s-.375-.336-.375-.75.168-.75.375-.75.375.336.375.75Zm-.375 0h.008v.015h-.008V9.75Z" />
  </svg>
);
...
export const FireIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => ( // For Calories
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.362 5.214A8.252 8.252 0 0 1 12 21 8.25 8.25 0 0 1 6.038 7.047 8.287 8.287 0 0 0 9 9.608a8.287 8.287 0 0 0 3 2.472A8.288 8.288 0 0 0 15 9.608a8.287 8.287 0 0 0 2.962-2.553A8.252 8.252 0 0 1 15.362 5.214Z" />
  </svg>
);

export const ProteinIcon: React.FC<React.SVGProps<SVGSVGElement> & { title?: string }> = ({ className, title, ...props }) => ( // Biceps icon for Protein
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    {title && <title>{title}</title>}
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 9.75a.75.75 0 0 0-1.5 0v1.5a4.505 4.505 0 0 1-4.5 4.5h-3a4.505 4.505 0 0 1-4.5-4.5v-6A4.505 4.505 0 0 1 10.5 5.25h1.5a.75.75 0 0 0 0-1.5H10.5A6.006 6.006 0 0 0 4.5 9.75v6A6.006 6.006 0 0 0 10.5 21.75h3A6.006 6.006 0 0 0 19.5 15.75V9.75Z M14.25 9a2.25 2.25 0 1 0 0-4.5 2.25 2.25 0 0 0 0 4.5Z" />
  </svg>
);

export const LeafIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => ( // For Carbs/Fats or general nutrition
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 14.155A7.502 7.502 0 0 1 18.75 21a7.5 7.5 0 0 1-3.03-14.482 7.5 7.5 0 0 1 7.145 2.802Zm-9.75-5.608A7.5 7.5 0 0 0 3.75 21a7.5 7.5 0 0 0 9.196-10.741 7.5 7.5 0 0 0-2.696-2.696Z" />
  </svg>
);
...
export const XCircleIcon: React.FC<React.SVGProps<SVGSVGElement> & { title?: string }> = ({ className, title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    {title && <title>{title}</title>}
...
export const ArrowRightOnRectangleIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
...
export const UserPlusIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
...
export const SparklesIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.813 15.904 9 18.75l-.813-2.846a4.5 4.5 0 0 0-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 0 0 3.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 0 0 3.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 0 0-3.09 3.09ZM18.259 8.715 18 9.75l-.259-1.035a3.375 3.375 0 0 0-2.455-2.456L14.25 6l1.036-.259a3.375 3.375 0 0 0 2.455-2.456L18 2.25l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 6l-1.035.259a3.375 3.375 0 0 0-2.456 2.456ZM18 15.75l.259 1.035a3.375 3.375 0 0 0 2.456 2.456L21.75 18l-1.035.259a3.375 3.375 0 0 0-2.456 2.456L18 21.75l-.259-1.035a3.375 3.375 0 0 0-2.456-2.456L14.25 18l1.036-.259a3.375 3.375 0 0 0 2.455-2.456Z" />
  </svg>
);
export const AICoachIcon = SparklesIcon;

export const ChartLineIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 18 9 11.25l4.306 4.306a11.95 11.95 0 0 1 5.814-5.518l2.74-1.22m0 0-5.94-2.281m5.94 2.28-2.28 5.941" />
  </svg>
);

export const BarcodeIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3.75 4.5v15a2.25 2.25 0 0 0 2.25 2.25h13.5a2.25 2.25 0 0 0 2.25-2.25v-15a2.25 2.25 0 0 0-2.25-2.25H5.25a2.25 2.25 0 0 0-2.25 2.25Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9v6m3-6v6m3-6v6" />
  </svg>
);
...
export const WaterDropIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || "w-6 h-6"} {...props}>
    <path fillRule="evenodd" d="M12.54 22.956c-2.32.348-4.634.348-6.953 0A8.941 8.941 0 0 1 3.42 15.1c-.352-1.192.174-2.474 1.173-3.213L8.25 8.25l1.03 1.03L12 6.53l2.72 2.75 1.03-1.03 3.658 3.639a2.25 2.25 0 0 1 1.025 2.053 9.041 9.041 0 0 1-4.996 7.91Z" clipRule="evenodd" />
  </svg>
);

export const RotateCcwIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M16.023 9.348h4.992v-.001M2.985 19.644v-4.992m0 0h4.992m-4.993 0 3.181 3.183a8.25 8.25 0 0 0 11.667 0l3.181-3.183m-4.991-2.691L7.985 5.982m0 0A8.25 8.25 0 0 1 12 2.25c4.556 0 8.25 3.694 8.25 8.25 0 1.561-.448 3.023-1.239 4.244" />
  </svg>
);
...
export const ChatBubbleLeftRightIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
...
export const CourseIcon = BookOpenIcon;
export const RecipeIcon = BookOpenIcon;
...
export const ShareIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M3 16.5v2.25A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75V16.5m-13.5-9L12 3m0 0 4.5 4.5M12 3v13.5" />
  </svg>
);
...
export const TrophyIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    ...
    <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 9.75c0 .75-.218 1.46-.62 2.062a9.72 9.72 0 0 1-1.282 1.638A9.72 9.72 0 0 1 12 15.75c-1.879 0-3.682-.55-5.1-1.55a9.72 9.72 0 0 1-1.282-1.638A5.25 5.25 0 0 1 4.5 9.75V5.25c0-1.518 1.232-2.75 2.75-2.75h9.5c1.518 0 2.75 1.232 2.75 2.75v4.5Z" />
    <path strokeLinecap="round" strokeLinejoin="round" d="M8.25 9.75h7.5" />
  </svg>
);

export const ScaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0 0 12 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c-.317.047-.634.09-.95.132m-11.6 0c.317.047.634.09.95.132m0 0A48.11 48.11 0 0 1 12 4.5c2.291 0 4.545.16 6.75.47M12 4.5v15.75" />
  </svg>
);

export const BellIcon: React.FC<React.SVGProps<SVGSVGElement> & { title?: string }> = ({ className, title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
    {title && <title>{title}</title>}
...
export const HeartIcon: React.FC<React.SVGProps<SVGSVGElement> & { title?: string }> = ({ className, title, ...props }) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className || "w-6 h-6"} {...props}>
    {title && <title>{title}</title>}
    <path d="m11.645 20.91-1.09-1.09C5.467 15.398 2.25 12.585 2.25 9.123c0-3.461 2.894-6.324 6.375-6.324 2.01 0 3.818.925 4.996 2.348C14.803 3.723 16.61 2.8 18.621 2.8c3.481 0 6.375 2.863 6.375 6.324 0 3.462-3.217 6.275-8.305 10.697l-1.09 1.09a.75.75 0 0 1-1.06 0Z" />
  </svg>
);
...
export const InstallIcon: React.FC<React.SVGProps<SVGSVGElement>> = ({ className, ...props }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className || "w-6 h-6"} {...props}>
