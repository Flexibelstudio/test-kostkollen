...
export const MacroCard: React.FC<MacroCardProps> = ({
  ...
  return (
    <div
      ...
      className={`flex flex-col justify-between bg-white dark:bg-[#2B2825] border border-neutral-light dark:border-[#484440] rounded-2xl p-3 sm:p-4 shadow-soft-sm text-center h-full`}
    >
      <div>
